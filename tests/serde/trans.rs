// use sentry_webhook::webhook::{WebhookRequest};
...
fn test_json_str() {
  let data = r#"
  {
    "id": "8",
    "project": "yolobase",
    "project_name": "yolobase",
    "project_slug": "yolobase",
    "logger": null,
    "level": "error",
    "culprit": "raven.scripts.runner in main",
    "message": "This is an example Python exception",
    "url": "http://34.29.134.26:9000/organizations/sentry/issues/8/?referrer=webhooks_plugin",
    "triggering_rules": [],
    "event": {
      "event_id": "174eff545784409b969f3fe4953db1af",
      "level": "error",
      "version": "5",
      "type": "default",
      "logentry": {
      ...
      "platform": "python",
      "timestamp": 1683528515.53,
      "received": 1683528575.532801,
      "environment": "prod",
      "user": {
        "id": "1",
      ...
      "_ref": 3,
      "_ref_version": 2,
      "_metrics": { "bytes.stored.event": 8034 },
      "nodestore_insert": 1683528576.498834,
      "id": "174eff545784409b969f3fe4953db1af"
    }
  }  
  "#;

  let contents = read_to_string("./webhook.json").expect("Should have been able to read the file");

   // Parse the string of data into serde_json::Value.
   let v: Value = serde_json::from_str(data).unwrap();

   assert_eq!(v["event"]["version"], "5");
}